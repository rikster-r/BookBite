...
const Dropdown = ({ name }) => {
  return (
    <div
      className={`hidden group-hover:xl:block absolute origin-top-right top-9 py-2 z-10 min-w-full rounded-md bg-white dark:bg-gray-800 shadow-lg ring-3 ring-white focus:outline-none`}
    >
      <div className="py-1">
        <Link
          to={`/profile/${name}`}
