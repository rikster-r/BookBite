    ...
    <div className="flex order-last sm:order-none mr-auto w-full sm:w-auto">
      ...
      <div className="relative flex w-full max-w-lg">
        ...
        <form onSubmit={handleQuery} className="w-full">
          <input
            type="text"
            className="w-full py-2 pl-10 pr-4 text-gray-700 bg-white border rounded-r-lg dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
            placeholder="Search"
            value={query}
